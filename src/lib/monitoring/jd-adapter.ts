/**
 * 京东言犀大模型平台适配器
 * 官方文档: https://agent.jd.com/
 * 支持平台下的所有模型
 */

import { IPlatformAdapter, PlatformConfig, PingResult, DEFAULT_TEST_MESSAGE, DEFAULT_TIMEOUT_MS } from './adapter';

export class JDAdapter implements IPlatformAdapter {
  readonly slug = 'jd';
  readonly name = '京东言犀';
  readonly defaultEndpoint = 'https://agentrs.jd.com/api/saas/openai-u/v1/chat/completions';
